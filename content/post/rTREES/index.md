...
If you look in the `PATH` variable above, you can see that `/usr/local/bin` in the 5th entry on that list. So my computer had to go through 5 items in my PATH variable to find a version of R.
